						...
						<form method="post" action="options.php">
							...
							<fieldset class="options">
								...
								<tr>
									...
									<td><label><textarea id="<?php echo $this->options_name ?>[html_top]" name="<?php echo $this->options_name ?>[html_top]" style="width: 100%; height: 150px;"><?php echo esc_attr($options['html_top']); ?></textarea>
								...
								<tr>
									...
									<td><label><textarea id="<?php echo $this->options_name ?>[html_bottom]" name="<?php echo $this->options_name ?>[html_bottom]" style="width: 100%; height: 150px;"><?php echo esc_attr($options['html_bottom']); ?></textarea>
