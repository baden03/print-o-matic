...
class WP_Print_O_Matic {
	...
	function printMaticInit() {
		//script
		wp_register_script('printomatic-js', plugins_url('/printomat.js', __FILE__), array('jquery'), '1.6.4');
			...
			<div style="margin:0 5px;">
				<div class="postbox">
					...
					<div class="inside">
						...
						<ol>
							<li><?php _e('You are an advanced user and have advanced needs.', 'print-o-matic'); ?></li>
							<li><?php _e('Print-O-Matic was just what I needed. Here, have some money.', 'print-o-matic'); ?></li>
