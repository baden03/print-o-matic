...
Description
-----------
Print-O-Matic adds the ability to print any post, page or page element by using a simple [print-me] shortcode.  Bonus feature: filled out form elements are also printed using a kind of jQuery Jedi magic.  A <a href='https://pluginoven.com/plugins/print-o-matic/documentation/'>complete listing of shortcode options</a> are available. Bugs and feature requests are tracked in <a href='https://github.com/baden03/print-o-matic/issues'>GitHub issues</a>.
...
* A .pot file has been included in the languages folder, along with a German (de_DE) translation. Further translations are welcome via <a href='https://github.com/baden03/print-o-matic'>github</a>.
